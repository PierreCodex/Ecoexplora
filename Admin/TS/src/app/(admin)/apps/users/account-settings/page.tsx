      ...
      <Row>
        <Col xs={12}>
          <Card className="overflow-hidden mb-0">
            <div className="position-relative card-side-img overflow-hidden" style={{ minHeight: 300, backgroundImage: `url(${profile.src})` }}>
              <div className="p-4 card-img-overlay rounded-start-0 auth-overlay d-flex align-items-center flex-column justify-content-center">
                ...
                <Button size="sm" variant="danger" type="button" className="mt-2">
                  Change Background
                </Button>
              </div>
            </div>
