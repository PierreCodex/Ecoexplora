      ...
      <CardBody>
        <div className="d-flex align-items-center mb-4">
          ...
          <div>
            <h5 className="mb-0 d-flex align-items-center">
              ...
              <Image src={us} alt="US" className="ms-2 rounded-circle" height={16} />
            </h5>
        ...
        <div>
          ...
          <div className="d-flex justify-content-center gap-2 mt-4 mb-2">
            ...
            <Link href="" className="btn btn-icon rounded-circle btn-success" title="Dribbble">
        ...
        <div className="d-flex flex-wrap gap-1">
          {skillData.map((skill, index) => (
            <Link key={index} className="btn btn-light btn-sm" href="">
              {skill}
            </Link>
          ))}
        </div>
