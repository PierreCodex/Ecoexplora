                ...
                <div className="mb-3">
                  ...
                  <div className="timeline-item d-flex align-items-start">
                    ...
                    <div className="timeline-content ps-3 pb-4">
                      <p className="mb-1">
                        <strong>New lead:</strong> <Link href="">John Carter</Link> added to the &quot;Enterprise&quot; pipeline by
                  ...
                  <div className="timeline-item d-flex align-items-start">
                    ...
                    <div className="timeline-content ps-3 pb-4">
                      <p className="mb-1">
                        <strong>Deal created:</strong> <Link href="">Q3 Licensing</Link> for John Carter added by
