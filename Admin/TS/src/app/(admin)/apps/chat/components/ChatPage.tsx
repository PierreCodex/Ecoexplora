              ...
              <Fragment key={message.id}>
                {currentContact.id === message.senderId && (
                  <div className="d-flex align-items-start gap-2 my-3 chat-item">
                    {currentContact.image ? (
                      <Image src={currentContact.image.src} width={36} height={36} className="avatar-md rounded-circle" alt="User" />
                    ) : (
                ...
                {currentUser.id === message.senderId && (
                  <div className="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    ...
                    {currentUser.image ? (
                      <Image src={currentUser.image} width={36} height={36} className="avatar-md rounded-circle" alt="User" />
                    ) : (
                      <span className="avatar-sm flex-shrink-0">
              ...
              >
                <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                  <span className="avatar avatar-sm flex-shrink-0">
                    {contact.image ? <Image src={contact.image} alt="" height={36} width={36} className="img-fluid rounded-circle" /> : <span className="avatar-title text-bg-primary fw-bold rounded-circle">{generateInitials(contact.name)}</span>}
                  </span>
